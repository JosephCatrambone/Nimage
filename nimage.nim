...
proc stbi_write_bmp(filename: string, w, h, comp: uint32, data: ptr uint8) {.importc.}
proc stbi_write_tga(filename: string, w, h, comp: uint32, data: ptr uint8) {.importc.}
proc stbi_write_hdr(filename: string, w, h, comp: uint32, data: ptr uint8) {.importc.}
